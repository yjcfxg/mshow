...
@interface MJKCatEarView()
@property (weak, nonatomic) IBOutlet UIView *playView;
/** 直播播放器 */
@property (nonatomic, strong) IJKFFMoviePlayerController *moviePlayer;
@end
@implementation MJKCatEarView
...
- (void)setLive:(MJKLive *)live
{
    ...
    IJKFFMoviePlayerController *moviePlayer = [[IJKFFMoviePlayerController alloc] initWithContentURLString:live.streamAddr withOptions:option];
...
- (void)setNearLive:(MJKNearLive *)nearLive
{
    ...
    // 开启硬解码
    [option setPlayerOptionValue:@"1" forKey:@"videotoolbox"];
    IJKFFMoviePlayerController *moviePlayer = [[IJKFFMoviePlayerController alloc] initWithContentURLString:nearLive.info.stream_addr withOptions:option];
